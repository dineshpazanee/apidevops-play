      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-whatshot"></i><span data-i18n="nav.advance_cards.main" class="menu-title">Advance Cards</span></a>
            <ul class="menu-content">
              <li><a href="card-statistics.html" data-i18n="nav.cards.card_statistics" class="menu"""),
format.raw("""-item">Statistics</a>
              </li>
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-xs-3 text-xs-center">
                        ...
                        <progr"""),
format.raw("""ess class="progress progress-xs mt-2 progress-success" value="90" max="100"></progress>
                    </div>
                </div>
            </div>
        </div>
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Sun Jul 30 16:48:29 IST 2017
                  SOURCE: /home/dinesh/Documents/devlopment/apidevops/apidevops-play/app/views/index.scala.html
                  HASH: 5e1e3e6abebc8b379f6b22a8b557b951bd6716b2
                  MATRIX: 811->0
                  LINES: 26->1
                  -- GENERATED --
              */
